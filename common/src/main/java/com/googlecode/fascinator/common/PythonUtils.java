...
public class PythonUtils {
	 ...
	 * @param queue
	 *            true if the destination is a queue, false for topic
	 * @return a JMS destination
	 * @throws JMSException
	 *             if an error occurred creating the destination
	 */
	 ...
	 *            the object to query
	 * @param plugin
	 *            the plugin we are interested in
	 * @return List<String> of roles with access to the object
	 */
	 ...
	 * 
	 * @param indexerFormats
	 *            The list of types so far allocated by the rules script.
	 * @param object
	 ...
	 * 
	 * @param index
	 *            : Data structure to add data into
	 * @param field
	 *            : The field name
	 * @param value
	 *            : The value to store
	 ...
	 * 
	 * @param fields
	 *            : The lists of evaluated fields for the document
